...
REPLACE INTO `nests` (`id`, `uuid`, `author`, `name`, `description`, `created_at`, `updated_at`) VALUES (5,'6b9ab860-30d5-46d9-87ec-de83e614bbf4','admin@sano.com','BOT ANJIR',NULL,'2025-12-14 09:34:10','2025-12-14 09:34:10');
...
REPLACE INTO `egg_variables` (`id`, `egg_id`, `name`, `description`, `env_variable`, `default_value`, `user_viewable`, `user_editable`, `rules`, `created_at`, `updated_at`) VALUES (72,15,'Install Branch','The branch to install.','BRANCH','',1,1,'nullable|string','2025-12-14 09:34:28','2025-12-14 09:34:28');
REPLACE INTO `egg_variables` (`id`, `egg_id`, `name`, `description`, `env_variable`, `default_value`, `user_viewable`, `user_editable`, `rules`, `created_at`, `updated_at`) VALUES (73,15,'Git Username','Username to auth with git.','USERNAME','',1,1,'nullable|string','2025-12-14 09:34:28','2025-12-14 09:34:28');
...
REPLACE INTO `egg_variables` (`id`, `egg_id`, `name`, `description`, `env_variable`, `default_value`, `user_viewable`, `user_editable`, `rules`, `created_at`, `updated_at`) VALUES (75,15,'Command Run','Command Start Bot','CMD_RUN','npm start',1,1,'required|string','2025-12-14 09:34:28','2025-12-14 09:34:28');
...
REPLACE INTO `egg_variables` (`id`, `egg_id`, `name`, `description`, `env_variable`, `default_value`, `user_viewable`, `user_editable`, `rules`, `created_at`, `updated_at`) VALUES (79,16,'Auto Update','Pull the latest files on startup when using a GitHub repo.','AUTO_UPDATE','0',1,1,'required|boolean','2026-01-21 12:04:29','2026-01-21 12:04:29');
REPLACE INTO `egg_variables` (`id`, `egg_id`, `name`, `description`, `env_variable`, `default_value`, `user_viewable`, `user_editable`, `rules`, `created_at`, `updated_at`) VALUES (80,16,'App py file','The file that starts the App.','PY_FILE','main.py',1,1,'required|string','2026-01-21 12:04:29','2026-01-21 12:04:29');
...
REPLACE INTO `egg_variables` (`id`, `egg_id`, `name`, `description`, `env_variable`, `default_value`, `user_viewable`, `user_editable`, `rules`, `created_at`, `updated_at`) VALUES (82,16,'Git Username','Username to auth with git.','USERNAME','',1,1,'nullable|string','2026-01-21 12:04:29','2026-01-21 12:04:29');
